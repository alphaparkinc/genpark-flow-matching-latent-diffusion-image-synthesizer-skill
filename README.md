# genpark-flow-matching-latent-diffusion-image-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Rectified flow matching latent diffusion and typography synthesizer (Black Forest Labs style)
